...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-netural-100 disabled:to-netural-100 disabled:text-netural-400 disabled:border-netural-100 disabled:text-netural-300 border border-netural-200 shadow-sm",
  {
    variants: {
      variant: {
        primary:
        ...
        muted:
          "bg-netural-200 text-netural-600 hover:bg-netural-200/800",
        link:
